...
class MainFragment : Fragment() {
    ...
    lateinit var viewModelList : MainViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        popularRecyclerView.layoutManager= LinearLayoutManager(requireContext(), RecyclerView.HORIZONTAL , false)
        ...
        upcomingRecyclerView.layoutManager= LinearLayoutManager(requireContext(), RecyclerView.HORIZONTAL , false)
        ...
        topRatedRecyclerView.layoutManager =LinearLayoutManager(requireContext(), RecyclerView.HORIZONTAL , false)
